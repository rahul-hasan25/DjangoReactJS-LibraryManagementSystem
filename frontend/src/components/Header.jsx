                ...
                <ul className="navbar-nav ms-auto d-flex align-items-center">
                    ...
                    { adminUser && (
                        ...
                        <li className='nav-item dropdown'>
                            ...
                            <ul className='dropdown-menu dropdown-menu-end'>
                                <li>
                                    <Link className="dropdown-item" to="/admin/book_add"><i className='fa-solid fa-plus me-1'></i>Add Book</Link>
                                </li>

                                <li>
                                    <Link className="dropdown-item" to="/admin/book_manage"><i className='fa-solid fa-list me-1'></i>Manage Book</Link>
                                </li>
                        ...
                        <li className="nav-item">
                            <Link className={`nav-link ${isActive("/admin/manage_students")}`} to="/admin/manage_students"><i className='fa-solid fa-users me-1'></i>Students</Link>
                        </li>
